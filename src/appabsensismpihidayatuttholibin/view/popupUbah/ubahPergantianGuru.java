...
public class ubahPergantianGuru extends javax.swing.JDialog {
     ...
     */
    public ubahPergantianGuru(java.awt.Frame parent, boolean modal, panelPergantianGuru pPerG) {
        super(parent, modal);
        initComponents();
    ...
    public void setDataPergantianGuru(String id, String tanggal, String guruUtama, String mapel, String jamKe, String tugasMateri, String guruPengganti, String keterangan) {
        ...
        try {
            SimpleDateFormat formatModel = new SimpleDateFormat("yyyy-MM-dd");
            Date tgl = formatModel.parse(tanggal);
            jTGL.setDate(tgl);
        } catch (ParseException parseException) {
            System.out.println("Gagal parsing tanggal: " + parseException.getMessage());
        }

        tJamke.setText(jamKe);
        tMapel.setText(mapel);
        tTugas.setText(tugasMateri);
        tKeterangan.setText(keterangan);

        cbNamaGuru.setSelectedItem(guruUtama);
        cbGuruPengganti.setSelectedItem(guruPengganti);
    }
    ...
    private void initComponents() {
        ...
        tTugas = new javax.swing.JTextArea();
        ...
        tTugas.setColumns(20);
        tTugas.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        tTugas.setRows(5);
        ...
        jScrollPane2.setViewportView(tKeterangan);
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        ...
        SimpleDateFormat formatMulai = new SimpleDateFormat("yyyy-MM-dd");
        String tanggal = (jTGL.getDate() != null) ? formatMulai.format(jTGL.getDate()) : "";

        String jamKe = tJamke.getText();
        String mapel = tMapel.getText();
        String tugasMateri = tTugas.getText();
        String keterangan = tKeterangan.getText();

        String namaGuruUtama = cbNamaGuru.getSelectedItem().toString();
        String namaGuruPengganti = cbGuruPengganti.getSelectedItem().toString();

        String sql = "UPDATE pergantian_guru SET "
                + "tanggal=?, "
                + "jam_ke=?, "
                + "mapel=?, "
                + "tugas_materi=?, "
        ...
        try {
            ...
            ps.setString(2, jamKe);
            ps.setString(3, mapel);
            ps.setString(4, tugasMateri);
            ps.setString(5, keterangan);
            ps.setString(6, cariNip(namaGuruUtama));
            ps.setString(7, cariNip(namaGuruPengganti));
            ps.setString(8, idPergantian);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ubahPergantianGuru dialog = new ubahPergantianGuru(new javax.swing.JFrame(), true, null);
    ...
    private javax.swing.JTextArea tTugas;
